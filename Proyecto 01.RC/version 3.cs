        ...
        case 1:
            {
                ...
                if (valida)
                {
                    if (tipoentretenimiento == 1 && (duracion < 60 || duracion > 180))
                    {
                        valida = false;
                        razon = "La duracion es invalida ya que no cumple";
                    }
                    else if (tipoentretenimiento == 2 && (duracion < 20 || duracion > 90))
                    {
                        valida = false;
                        razon = "La duracion es invalida ya que no cumple";
                    }
                    else if (tipoentretenimiento == 3 && (duracion < 30 || duracion > 120))
                    {
                        valida = false;
                        razon = "La duracion es invalida ay que no cumple";
                    }
                    else if (tipoentretenimiento == 4 && (duracion < 30 || duracion > 240))
                    {
                        valida = false;
                        razon = "La duracion es invalida poruqe no cumple";
                    }
                }
            }
    }
