...
class Program
{
    ...
    static int ttevaluados = 0;     /*Guardamos variable que va contar de total evaluados*/
    static int rechazados = 0;      /*Guardamos variable que va contar los rechazados*/
    static string impacto;        /*Guardamos variable de impacto*/
    static int revision = 0;           /*Guardamos variable que va contar las revisiones*/
    static int publicarla = 0;         /*Guardamos variable que va contar al publicarla*/
    static double porcentaje;            /*Guardamos variable de porcentaje*/
    ...
    static void Evaluar()
    {
        ...
        {
            impacto = "Bajo";        /*Guardamos variable de impacto*/
            ...
            {
                if (horaprogra <= 23)     /* ccondicionamos*/
                {
                    impacto = "Alto";
                }
            }
            else if (nivelprodu == 2 || (duracion >= 60 && duracion <= 120))/*condicionamos nivel con la duracion para el impacto*/
            {
                impacto = "Medio";
            }
    ...
    {
        ttevaluados = 0;          /*Reinicamos estadisticas*/
        rechazados = 0;
        revision = 0;
        publicarla = 0;
